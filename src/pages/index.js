        ...
        <Layout className="!pt-24 md:!pt-16 sm:!pt-28">
          <div className="flex w-full items-start justify-between md:flex-col pt-10 pb-24">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              I am an informatics fresh graduate with an interest in working as a mobile developer and web developer. 
              While studying at Diponegoro University, I regularly improved my programming skills so that later I could provide great benefits in the professional world.
              </p>
