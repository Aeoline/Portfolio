    ...
    <>
      ...
      <main className="h-[100vh] w-full dark:bg-dark ">
        <Layout className="relative !bg-transparent !pt-16 flex flex-col items-center justify-center">
          <AnimatedText text="Coming Soon! 🚀" className=" " />
          <AnimatedText text="Thanks for stopping by, but my brain is currently on a snack break. Stay tuned for the awesomeness!" className=" !text-3xl " />
          <Link
            href="/"
